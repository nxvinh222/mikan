...
import '../assets/css/delconfirm.css'
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 card-margin">
                        <div className="card card-employee search-form">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="row no-gutters">
                                                ...
                                                <div className="col-lg-7 col-md-5 col-sm-12 p-0">
                                                    <input type="text" placeholder="Search..." className="form-control" id="search" name="search" />
                                                </div>
                                                <div className="col-lg-1 col-md-2 col-sm-12 p-0">
